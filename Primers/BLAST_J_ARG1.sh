...
#SBATCH --output=BLAST_Jutta_ARG1.out
#SBATCH --error=BLAST_Jutta_ARG1.err
...
echo "Starting BLAST DB making for file: $base"
makeblastdb -in CONCANATENATE_FAA_FILES_fromGENOMEs.faa /
     -title CONCANATENATE_FAA_FILES_fromGENOMEs_DB
     -input_type fasta /
     -dbtype prot

echo "Finished BLAST DB making for file: $base"
done
