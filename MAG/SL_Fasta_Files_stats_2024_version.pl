...
# Get input arguments
my $folder = $ARGV[0] or die "Usage: $0 <folder> [cutoff_length]\n";
my $cutoff_length = $ARGV[1] // 0;  # Default to 0 if not provided
...
open my $out, '>', "$folder/${cutoff_length}_Statistics.xls" or die "Could not write to output file: $!\n";
...
close $out;
print "Statistics written to $folder/${cutoff_length}_Statistics.xls\n";
