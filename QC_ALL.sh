...
#SBATCH --output=QC_all.out
#SBATCH --error=QC_all.err
...
PacBio_EC_CANU="/gxfs_work/geomar/smomw681/DATA/PacBio_Assembly/Canu"
PacBIO_EC_metaFlye="/gxfs_work/geomar/smomw681/DATA/PacBio_Assembly/metaFlye"

ASSEM_DIR="/gxfs_work/geomar/smomw681/DATA/MAG_Illumina/CONTIGs_renamed"
dir11="${QC_ALL_DIR}/QC_EC_ALL"    
fastqc --memory 10GB -f fastq -t 4 -noextract -o $dir11 ${ASSEM_DIR}/*_renamed.fasta ${PacBIO_EC_metaFlye}/*/*_assembly.fasta # .trimmedReads.fasta.gz for Canu EC_trimmed
multiqc -o ${dir11} -n EC_fastqc_summary ${dir11}
## doesn't work due to lack of Qualtiy score in fasta files
