...
#SBATCH --output=CoverM_Proks_contig_EC.out
#SBATCH --error=CoverM_Proks_contig_EC.err
...
# Set up variables
export PROKS_Contigs="/gxfs_work/geomar/smomw681/DATA/MAG_Illumina/CLASS_CONTIGs/PROKS"
export EC_READs="/gxfs_work/geomar/smomw681/DATA/ERROR_CORRECTED"
export CoverM_DIR="/gxfs_work/geomar/smomw681/DATA/MAG_Illumina/CoverM_PROKs/CoverM_Proks_Contigs"
...
coverm contig \
     ...
     --methods count mean rpkm reads_per_base covered_bases  \
     --interleaved ${EC_READs}/${base}.qc.ec.PE.fq.gz \
     --reference ${PROKS_Contigs}/${base}_contigs_mind500_Proks.fna \
     --output-file ${CoverM_DIR}/${base}.coverm_proks_contigs.tsv
done

# export dREP_FILEs="/gxfs_work/geomar/smomw681/DATA/MAG_ALL/dREP_ALL/dereplicated_genomes"
# export EC_READs="/gxfs_work/geomar/smomw681/DATA/ERROR_CORRECTED"
# export CoverM_DIR="/gxfs_work/geomar/smomw681/DATA/MAG_ALL/CoverM_ALL/CoverM_more"
...
#      --min-read-aligned-percent 0.80 \
#      --min-covered-fraction 10 \
#      --methods rpkm mean covered_fraction relative_abundance \
#      --interleaved ${EC_READs}/${base}.qc.ec.PE.fq.gz \
