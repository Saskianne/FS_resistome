...
#SBATCH --output=Prodigal_Jutta_strain_ALL3.out
#SBATCH --error=Prodigal_Jutta_strain_ALL3.err
...
##TO-DO after access to U drive, modify the paths
...
# python ${MAG_Files}/SL_Extract_complete_or_partial_genes_fromProdigalPredictions.py \
#      -i ${ProdDIR}/Prodigal_InHouse/${base}.CDS.fna \
#      -o ${Prod_COMPLETE}/${base}.COMPLETE.CDS.fna \
#      -r partial=00
# done
