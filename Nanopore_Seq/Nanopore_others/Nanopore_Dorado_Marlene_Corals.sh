...
#SBATCH --output=Dorado_Nanopore_Marlene_Corals_2016Samples_1_Dorado.out
#SBATCH --error=Dorado_Nanopore_Marlene_Corals_2016Samples_1_Dorado.err
...
cd /gxfs_work/geomar/smomw681/NANOPORE_DATA/Marlene_Corals_2016Samples
RAW_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/Marlene_Corals_2016Samples/pod5"
BASECALL_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/Marlene_Corals_2016Samples/BASECALLING"
DEMUX_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/Marlene_Corals_2016Samples/MULTIPLEXED"
...
/gxfs_work/geomar/smomw681/DORADO/dorado-0.9.5-linux-x64-cuda-11.8/bin/dorado basecaller $DORADO_MODEL_DIR/ $RAW_DIR/ --kit-name SQK-RBK004 --trim adapters --device cpu --output-dir $BASECALL_DIR/ >  Marlene_Corals_2016Samples_basecalled.bam 
