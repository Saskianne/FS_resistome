...
#SBATCH --output=bioc202_AMR_1_Dorado.out
#SBATCH --error=bioc202_AMR_1_Dorado.err
...
cd /gxfs_work/geomar/smomw681/NANOPORE_DATA/AMR_bioc202_2025_Seq
RAW_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/AMR_bioc202_2025_Seq/pod5"
BASECALL_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/AMR_bioc202_2025_Seq/BASECALLING"
DEMUX_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/AMR_bioc202_2025_Seq/DEMULTIPLEXED"
...
/gxfs_work/geomar/smomw681/DORADO/dorado-0.9.5-linux-x64-cuda-11.8/bin/dorado basecaller $DORADO_MODEL_DIR/ $RAW_DIR/ --kit-name SQK-RBK004 --trim adapters --device cpu --output-dir $BASECALL_DIR/ >  AMR_bioc202_2025_basecalled.bam 
