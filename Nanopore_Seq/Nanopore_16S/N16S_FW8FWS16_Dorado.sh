...
#SBATCH --output=N16S_FW8FWS16_Dorado.out
#SBATCH --error=N16S_FW8FWS16_Dorado.err
...
conda activate DORADO_1.1.1
cd /gxfs_work/geomar/smomw681/NANOPORE_DATA/16S_AMPLICON_SEQ
RAW_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/16S_AMPLICON_SEQ/16S_FW8_FWS16_SL/pod5"
BASECALL_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/BASECALLING"
DEMUX_DIR="/gxfs_work/geomar/smomw681/NANOPORE_DATA/DEMULTIPLEXED/FW_8_FWS_16_SL_DEMUX"
...
dorado basecaller $MODEL_DIR/ $RAW_DIR/ --emit-fastq --kit-name SQK-16S114-24 --trim adapters --device cpu --output-dir $BASECALL_DIR/ >  /gxfs_work/geomar/smomw681/NANOPORE_DATA/BASECALLING/16S_Amplicon_FW8_FWS16_SL_basecalled.bam 
