...
#SBATCH --output=Illumina_assem_mulQC_try.out
#SBATCH --error=Illumina_assem_mulQC_try.err
...
multiqc --force -o $dir3 -n RAW_fastqc_summary -i RAW_fastqc_summary -p  ${dir3}   
...
multiqc --force -o ${dir5} -n TRIM_fastqc_summary -i TRIM_fastqc_summary ${dir5}      
...
multiqc --force -o ${dir7} -n FILTER_fastqc_summary -i FILTER_fastqc_summary ${dir7}
...
# fastqc --memory 10GB -f fastq -t 4 -noextract -o $dir11/${ASSEM_QC_DIR[@]} ${ASSEM_DIR[@]}/contigs.fasta 
