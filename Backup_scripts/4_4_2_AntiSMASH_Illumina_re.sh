...
# Set up variables
MAG_Illumina="/gxfs_work/geomar/smomw681/DATA/MAG_Illumina/METABAT2/METABAT2_PROKS_BIN"
DBDIR="/gxfs_work/geomar/smomw681/.conda/envs/AntiSMASH/lib/python3.10/site-packages/antismash/databases"
ANTISMASH_DIR="/gxfs_work/geomar/smomw681/DATA/MAG_Illumina/METABAT2/AntiSMASH_Illumina"

for file in ${MAG_Illumina}/*.fa; do
