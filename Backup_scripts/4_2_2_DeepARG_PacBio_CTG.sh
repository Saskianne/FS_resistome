...
CTG_metaFlye="/gxfs_work/geomar/smomw681/DATA/PacBio_Assembly/metaFlye"
ProdDIR="/gxfs_work/geomar/smomw681/DATA/PacBio_Assembly/metaFlye/Prodigal_PacBio_CTG"

echo "START TIME": '' $(date)

# Run prodigal 
echo Start running prodigal at $(date)
for i in ${CTG_metaFlye}/*/*.fasta ;
do
...
DeepARGsDIR="/gxfs_work/geomar/smomw681/DATA/PacBio_Assembly/metaFlye/DeepARG_PacBio_CTG"
